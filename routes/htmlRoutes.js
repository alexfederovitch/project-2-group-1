...
module.exports = function(app) {
  ...
  app.get("/user/meal", function(req, res) {
    ...
    db.Users.findAll({
      ...
      db.meals.findAll({
        ...
        db.meals
          .sum("calories", { where: { day: "Monday", consumed: true } })
          .then(sum => {
            ...
            //Querying fat data
            db.meals
              .sum("fat", { where: { day: "Monday", consumed: true } })
              .then(sum => {
                ...
                //Querying carb data
                db.meals
                  .sum("carbs", { where: { day: "Monday", consumed: true } })
                  .then(sum => {
                    ...
                    db.meals
                      .sum("protein", {
                        where: { day: "Monday", consumed: true }
                      })
                      .then(sum => {
  ...
  //LOAD individual meal by day page
